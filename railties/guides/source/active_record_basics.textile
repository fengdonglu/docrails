...
本指南是Active Record的介绍。我们希望你通过本指南学到：
...
Active Record使用名称转换for the columns in database tables, depending on the purpose of these columns.
